...
class TestRPyCCommandService(TestCase):
    def setUp(self) -> None:
        ...
        self.command_middleware_executor_mock = Mock(spec=CommandMiddlewareExecutor)
        self.rpyc_command_service = RPyCCommandService(
            self.command_deserializer_mock, self.command_middleware_executor_mock
        )
    ...
    def test_command_executor_success(self):
        ...
        self.rpyc_command_service.passenger_executor(
        ...
        self.command_middleware_executor_mock.execute.assert_called_once_with(test_command, test_command_handler)

    def test_command_executor_not_command(self):
