...
class TestRPyCQueryService(TestCase):
    def setUp(self) -> None:
        ...
        self.rpyc_query_service = RPyCQueryService(
            self.query_deserializer_mock, self.query_response_serializer_mock, self.query_receiver_mock
        )
    ...
    def test_query_handling_success(self):
        ...
        serialized_query_response = self.rpyc_query_service.passenger_receiver(
    ...
    def test_query_handling_not_query(self):
        ...
        with self.assertRaises(TypeError):
            self.rpyc_query_service.passenger_receiver(
